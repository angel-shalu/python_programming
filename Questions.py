...
# ======================================================================
# 2. Write a python programm to check the number is happy or not.
# ======================================================================
...
# ========================================================================
# 3. Write a python programm to find the HCF from for user input.
# ========================================================================
a = int(input("Enter the first number:"))
b = int(input("Enter the second number:"))
while b !=0:
    a,b = b, a % b
print("HCF of the number = ",a)


# ===========================================================================
# 4. WAP to fins the mounted top element from a given list 1,3,5,9,13,2,3,1.
# ===========================================================================
