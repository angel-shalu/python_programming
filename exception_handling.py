...
"""
    ...
    1. Pre-Defined Exceptions :- These are the exceptions which are already defined in python and we can use them directly.
    2. User Defined Exceptions :- These are the exceptions which are defined by the user according to the requirement of the program.
    
    How to create user defined exception in python ?
    => We can create user defined exception in python using class and raise keyword.
